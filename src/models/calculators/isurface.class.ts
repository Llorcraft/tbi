...
class ISurfaceCalculator extends BaseCalculator {
  constructor(report: ReportBase) {
    super(report, [
      ...
      /*01min*/() => this.hr_min = this.ε * this.δ * (Math.pow(this.θse_min + 273, 4) - Math.pow(this.θa_min + 273, 4)) / ((this.θse_min + 273) - (this.θa_min + 273)),
      ...
      /*20*/() => this.q_min = this.hse_min * Math.abs(this.θse_min - this.θa_min),
