...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_report_router__ = __webpack_require__(184);
...
var ProjectsPage = /** @class */ (function (_super) {
    ...
    ProjectsPage.prototype.go_next = function () {
        if (!!this.projects.length && !this.projects[0].components.length) {
            ...
            (new __WEBPACK_IMPORTED_MODULE_11__models_report_router__["a" /* ReportRouter */](this.projects[0], this.projects[0].components[0], this.navCtrl)).navigate_to_report(this.projects[0].components[0].reports[0].path, this.projects[0].components[0].reports[0].summary_id, this.projects[0].components[0].reports[0], null, this.projects[0].components[0].result);
        }
    };
