...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component__ = __webpack_require__(170);
...
var Fields = /** @class */ (function () {
    ...
    Object.defineProperty(Fields.prototype, "condensation_other", {
        get: function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__licences_service__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fields__ = __webpack_require__(168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__progress_kendo_drawing__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__projects_projects__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services__ = __webpack_require__(17);
...
var SummaryPage = /** @class */ (function () {
    ...
    SummaryPage.prototype.go_to_projects = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__projects_projects__["a" /* ProjectsPage */]);
    };
    ...
    SummaryPage.prototype.add_report = function (type, event) {
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        _this.service.save(_this.project);
                    }
                },
                {
                    text: 'No',
    ...
    SummaryPage.prototype.export_pdf = function (pdf) {
        ...
        pdf.export().then(function (g) {
            Object(__WEBPACK_IMPORTED_MODULE_8__progress_kendo_drawing__["b" /* exportPDF */])(g).then(function (data) {
    ...
    SummaryPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__services__["b" /* MessageService */],
            __WEBPACK_IMPORTED_MODULE_11__ionic_native_file_opener__["a" /* FileOpener */],
            __WEBPACK_IMPORTED_MODULE_10__services__["a" /* FileService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__leakage_report_leakage_component__ = __webpack_require__(308);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__const_images__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reports_report_leakage__ = __webpack_require__(307);
    ...
    ReportRouter.prototype.create_report = function (path, summary_id, report) {
        ...
        switch (path) {
            ...
            case __WEBPACK_IMPORTED_MODULE_0__const_report_const__["a" /* REPORT */].MANTENANCE.CONDENSATION:
                ...
                break;
            case __WEBPACK_IMPORTED_MODULE_0__const_report_const__["a" /* REPORT */].MANTENANCE.LEAKAGE:
                _report = new __WEBPACK_IMPORTED_MODULE_4__reports_report_leakage__["a" /* ReportLeakage */](this.project, this.component, report);
                break;
            default:
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__report_base__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_reports_leakage_report_leakage_component__ = __webpack_require__(308);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_report_service__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_messages_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_reports_report_leakage__ = __webpack_require__(307);
...
var DownloadPage = /** @class */ (function () {
    function DownloadPage(navCtrl, file, service) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.file = file;
        this.service = service;
    ...
    DownloadPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services__["a" /* FileService */], __WEBPACK_IMPORTED_MODULE_2__services__["d" /* ProjectService */]])
    ], DownloadPage);
    return DownloadPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__services_report_service__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__services_licences_service__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_71__pages_reports__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_72__pipes_surface_material_pipe__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_73__progress_kendo_angular_pdf_export__ = __webpack_require__(696);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["a" /* GenericReportPage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["v" /* ReportsPage */],
                ...
                //Pipes
                __WEBPACK_IMPORTED_MODULE_72__pipes_surface_material_pipe__["a" /* SurfaceMaterialPipe */],
                //
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["f" /* ReportEditPictureComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["p" /* ReportPictureSlideComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["j" /* ReportHeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["i" /* ReportFooterComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["b" /* ReportAreaButtonComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["c" /* ReportAreaModalComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["o" /* ReportMoreButtonComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["n" /* ReportMediumTempButtonsComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["t" /* ReportTempMarkersWindowComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["g" /* ReportErrorsComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["r" /* ReportResultComponent */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["s" /* ReportSurfacePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["l" /* ReportInsulatedSurfacePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["h" /* ReportFlangePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["q" /* ReportPipePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["k" /* ReportInsulatedPipePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["u" /* ReportValvePage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["e" /* ReportDamagedPage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["d" /* ReportCondensationPage */],
                __WEBPACK_IMPORTED_MODULE_71__pages_reports__["m" /* ReportLeakagePage */],
                //Components
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_73__progress_kendo_angular_pdf_export__["a" /* PDFExportModule */]
            ],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__value__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__project__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fields__ = __webpack_require__(168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__component__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_scroll_to_component_class__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__const_images__ = __webpack_require__(169);
...
var ReportFlangePage = /** @class */ (function (_super) {
    ...
    ReportFlangePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-report-flange',template:/*ion-inline-start:"D:\Sofware Factory\tbi\src\pages\reports\flange\report-flange.component.html"*/'<report-header [parent]="this"></report-header>\n\n\n\n<ion-content #content>\n\n\n\n  <ion-grid [hidden]="view==\'edit_picture\'" class="fixed-col">\n\n    <ion-row>\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n\n\n        <form novalidate #form="ngForm" [hidden]="segment!=\'input\'" (submit)="calculate()">\n\n          <ion-row>\n\n            <ion-col col-7>\n\n              <ion-item>\n\n                <ion-label stacked>Component/Location</ion-label>\n\n                <ion-input tabindex="1" (ionFocus)="on_focus($event)" name="location" required data-val-required="Please input Component/Location"\n\n                  [(ngModel)]="report.component.fields.location" type="text"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-3>\n\n              <ion-item>\n\n                <ion-label stacked>Item number</ion-label>\n\n                  <ion-input min="0" tabindex="2"(ionFocus)="on_focus($event)" name="number" required data-val-required="Please input Item number" [(ngModel)]="report.component.fields.number"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Operational time (hours)</ion-label>\n\n                <ion-input tabindex="3" (ionFocus)="on_focus($event)" required data-val-required="Please input operational time" name="operational_time" [(ngModel)]="report.component.fields.operational_time"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #time (change)="report.component.fields.operational_time=time.value" [type]="\'time\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Nominal diameter (DN)</ion-label>\n\n                  <ion-input #after_time tabindex="4" (ionFocus)="on_focus($event)" name="nominal_diameter" required data-val-required="Please input Nominal diameter" [(ngModel)]="report.component.fields.nominal_diameter"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <div (click)="set_length(\'Default value for flanges 0.5m\', 0.5)" tabindex="-1" pull-left no-padding ion-button small color="light" class="with-action">\n\n                  <ion-icon name="custom-flange"></ion-icon>\n\n                </div>\n\n          </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item class="edit_surface_material" [class.editable]="edit_surface_material">\n\n                <ion-label stacked>Surface material [ε]</ion-label>\n\n                <ion-input tabindex="5" class="literal" (focus)="toggle_surface_material(true)" [value]="report.component.fields.surface_material_friendly" type="text"></ion-input>\n\n                <ion-input tabindex="6" class="numeric" (focusout)="toggle_surface_material(false)" (ionFocus)="on_focus($event)" name="surface_material" required data-val-required="Please input surface emissivity" [(ngModel)]="report.component.fields.surface_material" type="number" (change)="set_surface_material(report.component.fields.surface_material, $event)"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #material (change)="set_surface_material(material.value, $event)" [type]="\'materials\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Medium or Surface temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input #after_material tabindex="7" (ionFocus)="on_focus($event)" name="surface_temp" \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Medium or Surface temperature" \n\n                  required data-val-required="Please input Medium or Surface temperature"  \n\n                  [(ngModel)]="report.component.fields.surface_temp" type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n                <medium-temp #medium [report]="report" modal-button pull-left></medium-temp>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n              <ion-col col-10>\n\n                <ion-item>\n\n                  <ion-label stacked>Ambient temperature (<sup>º</sup>C)</ion-label>\n\n                    <ion-input tabindex="8" (ionFocus)="on_focus($event)" (keyup.enter)="on_keypress($event)" name="ambient_temp" \n\n                    [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Ambient temperature" \n\n                  required data-val-required="Please input Ambient temperature"  \n\n                    [(ngModel)]="report.component.fields.ambient_temp"\n\n                    type="tel"></ion-input>\n\n                </ion-item>\n\n              </ion-col>\n\n              <ion-col col-2></ion-col>\n\n          </ion-row>\n\n        </form>\n\n      </ion-col>\n\n\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 picture-slide  [report]="report" [editable]="editable"  (onStartEdit)="on_picture_start_edit($event)">\n\n        </ion-col>\n\n      </ion-row>\n\n      <report-errors padding #errors col-12 [hidden]="view==\'!result\' && report.result"></report-errors>\n\n      <report-result col-12 [parent]="this" *ngIf="view==\'result\' && (!!form && !form.invalid)"></report-result>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n  <edit-picture *ngIf="view==\'edit_picture\'"  [report]="report"  [picture]="editing_picture" ></edit-picture>\n\n\n\n</ion-content>\n\n\n\n<report-footer [parent]="this"></report-footer>'/*ion-inline-end:"D:\Sofware Factory\tbi\src\pages\reports\flange\report-flange.component.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__services_report_service__["a" /* ReportService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__const_images__ = __webpack_require__(169);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__segment_segment_class__ = __webpack_require__(504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__summary_summary__ = __webpack_require__(179);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ReportsPage = /** @class */ (function (_super) {
    ...
    function ReportsPage(navCtrl, navParams, alertCtrl, service) {
        ...
        _this.service = service;
        _this.type = "";
        _this.segment = new __WEBPACK_IMPORTED_MODULE_6__segment_segment_class__["a" /* Segment */]();
        ...
        console.table(_this.component);
        _this.segment.set(_this.type);
        if (!!navParams.get('to'))
    ...
    ReportsPage.prototype.open_summary = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__summary_summary__["a" /* SummaryPage */], { project: this.project });
    };
...
var Segment = /** @class */ (function () {
    function Segment() {
        this.value = 0;
        this.visible_group = 0;
        this.options = [];
        this.hidden = false;
    }
    Segment.prototype.set = function (option) {
        this.value = 0;
        var options = {
            '': [],
...
//# sourceMappingURL=segment.class.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__licences_service__ = __webpack_require__(101);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_report_service__ = __webpack_require__(29);
...
var ReportSurfacePage = /** @class */ (function (_super) {
    ...
    ReportSurfacePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-report-surface',template:/*ion-inline-start:"D:\Sofware Factory\tbi\src\pages\reports\surface\report-surface.component.html"*/'<report-header [parent]="this"></report-header>\n\n\n\n<ion-content #content>\n\n\n\n  <ion-grid [hidden]="view==\'edit_picture\'" class="fixed-col">\n\n    <ion-row >\n\n      <ion-col col-7 col-lg-8 no-padding>\n\n        <form novalidate #form="ngForm" [hidden]="segment!=\'input\'" (submit)="calculate()">\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Component/Location</ion-label>\n\n                <ion-input tabindex="1" name="location" required data-val-required="Please input Component/Location"\n\n                  [(ngModel)]="report.component.fields.location" (ionFocus)="on_focus($event)" type="text"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-12></ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Operational time (hours)</ion-label>\n\n                <ion-input tabindex="2" (ionFocus)="on_focus($event)" required data-val-required="Please input operational time" name="operational_time" [(ngModel)]="report.component.fields.operational_time"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #time (change)="report.component.fields.operational_time=time.value" [type]="\'time\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-5>\n\n              <ion-item>\n\n                <ion-label stacked>Surface (m<sup>2</sup>)</ion-label>\n\n                    <ion-input tabindex="4" #after_time (ionFocus)="on_focus($event)" \n\n                    [disabled]="report.component.fields.unknow_surface" \n\n                    name="surface" \n\n                    required data-val-required="Please input surface in m²" \n\n                    [(ngModel)]="report.component.fields.surface" type="number"\n\n                    [(ngModel)]="surface"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-5 toggle-container style="padding-top: 1.5rem">\n\n                <ion-item>\n\n                <ion-label stacked style="margin-top: 1.3rem">Unknown</ion-label>\n\n                <ion-toggle style="padding-left:0" [(ngModel)]="report.component.fields.unknow_surface" (ionChange)="toggle_know()" name="unknow_surface"></ion-toggle>\n\n                </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <area [hidden]="unknow_surface" pull-left #area (change)="report.component.fields.surface=area.value" modal-button />\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item class="edit_surface_material" [class.editable]="edit_surface_material">\n\n                <ion-label stacked>Surface material [ε]</ion-label>\n\n                <ion-input tabindex="5" class="literal" (ionFocus)="on_focus($event); toggle_surface_material(true)" [value]="report.component.fields.surface_material_friendly" type="text"></ion-input>\n\n                <ion-input tabindex="6" class="numeric" (ionFocus)="on_focus($event)" (focusout)="toggle_surface_material(false)" name="surface_material" required data-val-required="Please input surface emissivity" [(ngModel)]="report.component.fields.surface_material" type="number" (change)="set_surface_material(report.component.fields.surface_material, $event)"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #material (change)="set_surface_material(material.value, $event)" [type]="\'materials\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Medium or Surface temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input tabindex="7" #after_material (ionFocus)="on_focus($event)" scroll="-80" name="surface_temp" \n\n                  required data-val-required="Please input Medium or Surface temperature"  \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Medium or Surface temperature"\n\n                  [(ngModel)]="report.component.fields.surface_temp" type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <!-- <medium-temp #medium (change)="report.component.fields.surface_temp=medium.value" modal-button pull-left></medium-temp> -->\n\n              <medium-temp #medium [report]="report" modal-button pull-left></medium-temp>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n              <ion-col col-10>\n\n                <ion-item>\n\n                  <ion-label stacked>Ambient temperature (<sup>º</sup>C)</ion-label>\n\n                    <ion-input tabindex="7" (ionFocus)="on_focus($event)" scroll="-90" (keyup.enter)="on_keypress($event)"  name="ambient_temp" \n\n                    [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Ambient temperature" \n\n                    required data-val-required="Please input Ambient temperature"  \n\n                    [(ngModel)]="report.component.fields.ambient_temp"\n\n                    type="tel"></ion-input>\n\n                </ion-item>\n\n              </ion-col>\n\n              <ion-col col-2></ion-col>\n\n          </ion-row>\n\n        </form>\n\n      </ion-col>\n\n\n\n      <ion-col col-5 col-lg-4 no-padding>\n\n        <ion-row>\n\n          <ion-col col-12 picture-slide  [report]="report" [editable]="editable"  (onStartEdit)="on_picture_start_edit($event)">\n\n        </ion-col>\n\n      </ion-row>\n\n      </ion-col>\n\n    </ion-row>\n\n    <ion-col col-12 padding>\n\n      <report-result col-12 [parent]="this" *ngIf="view==\'result\' && (!!form && !form.invalid)"></report-result>\n\n    </ion-col>\n\n    <ion-col col-12 padding>\n\n      <report-errors padding #errors col-12 [hidden]="view==\'!result\' && report.result"></report-errors>\n\n    </ion-col>\n\n  </ion-grid>\n\n\n\n  <edit-picture *ngIf="view==\'edit_picture\'"  [report]="report"  [picture]="editing_picture" ></edit-picture>\n\n\n\n</ion-content>\n\n\n\n<report-footer [parent]="this"></report-footer>'/*ion-inline-end:"D:\Sofware Factory\tbi\src\pages\reports\surface\report-surface.component.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__services_report_service__["a" /* ReportService */],
...
var ReportMoreButtonComponent = /** @class */ (function () {
    function ReportMoreButtonComponent(actionSheetCtrl, keyboard) {
        this.actionSheetCtrl = actionSheetCtrl;
        this.keyboard = keyboard;
        this.value = null;
        this.type = '';
    ...
    ReportMoreButtonComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Keyboard */]])
...
var ReportInsulatedSurfacePage = /** @class */ (function (_super) {
    ...
    ReportInsulatedSurfacePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-report-surface',template:/*ion-inline-start:"D:\Sofware Factory\tbi\src\pages\reports\isurface\report-isurface.component.html"*/'<report-header [parent]="this"></report-header>\n\n\n\n<ion-content #content>\n\n\n\n  <ion-grid [hidden]="view==\'edit_picture\'" class="fixed-col">\n\n    <ion-row >\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n        <form novalidate #form="ngForm" [hidden]="segment!=\'input\'" (submit)="calculate()">\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Component/Location</ion-label>\n\n                <ion-input tabindex="1" (ionFocus)="on_focus($event)" name="location" required data-val-required="Please input Component/Location"\n\n                  [(ngModel)]="report.component.fields.location" type="text"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-12></ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Operational time (hours)</ion-label>\n\n                <ion-input tabindex="2" (ionFocus)="on_focus($event)" required data-val-required="Please input operational time" name="operational_time" [(ngModel)]="report.component.fields.operational_time"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #time (change)="report.component.fields.operational_time=time.value" [type]="\'time\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-6>\n\n              <ion-item>\n\n                <ion-label stacked>Surface (m<sup>2</sup>)</ion-label>\n\n                <ion-input #after_time tabindex="3" (ionFocus)="on_focus($event)" \n\n                [disabled]="report.component.fields.unknow_surface" \n\n                name="surface" \n\n                required data-val-required="Please input surface in m²" \n\n                [(ngModel)]="report.component.fields.surface" type="number"\n\n                [(ngModel)]="surface"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-4 toggle-container style="padding-top: 1rem">\n\n                <ion-label stacked style="margin-top: 1.5rem">Unknown</ion-label>\n\n                <ion-toggle [(ngModel)]="report.component.fields.unknow_surface" (ionChange)="toggle_know()" name="unknow_surface"></ion-toggle>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <area [hidden]="unknow_surface" pull-left #area (change)="report.component.fields.surface=area.value" modal-button />\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item class="edit_surface_material" [class.editable]="edit_surface_material">\n\n                <ion-label stacked>Surface material [ε]</ion-label>\n\n                <ion-input tabindex="5" class="literal" (ionFocus)="on_focus($event);toggle_surface_material(true)" [value]="report.component.fields.surface_material_friendly" type="text"></ion-input>\n\n                <ion-input tabindex="6" class="numeric" (ionFocus)="on_focus($event)" (focusout)="toggle_surface_material(false)" name="surface_material" required data-val-required="Please input surface emissivity" [(ngModel)]="report.component.fields.surface_material" type="number" (change)="set_surface_material(report.component.fields.surface_material, $event)"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #material (change)="set_surface_material(material.value, $event)" [type]="\'materials\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Surface temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input #after_material tabindex="7" (ionFocus)="on_focus($event)" name="surface_temp" \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Surface temperature" \n\n                  required data-val-required="Please input Surface temperature"  \n\n                  [(ngModel)]="report.component.fields.surface_temp" type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <!-- <medium-temp #medium (change)="report.component.fields.surface_temp=medium.value" modal-button pull-left></medium-temp> -->\n\n              <medium-temp #medium [report]="report" modal-button pull-left></medium-temp>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Medium temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input tabindex="8" (ionFocus)="on_focus($event)" name="medium_temp" \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Medium temperature" \n\n                  required data-val-required="Please input Medium temperature"  \n\n                  [(ngModel)]="report.component.fields.medium_temp"\n\n                  type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2></ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n              <ion-col col-10>\n\n                <ion-item>\n\n                  <ion-label stacked>Ambient temperature (<sup>º</sup>C)</ion-label>\n\n                    <ion-input tabindex="9" (ionFocus)="on_focus($event)" (keyup.enter)="on_keypress($event)"  name="ambient_temp" \n\n                    [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Ambient temperature" \n\n                    required data-val-required="Please input Ambient temperature"  \n\n                    [(ngModel)]="report.component.fields.ambient_temp"\n\n                    type="tel"></ion-input>\n\n                </ion-item>\n\n              </ion-col>\n\n              <ion-col col-2></ion-col>\n\n          </ion-row>\n\n        </form>\n\n      </ion-col>\n\n\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 picture-slide  [report]="report" [editable]="editable"  (onStartEdit)="on_picture_start_edit($event)">\n\n        </ion-col>\n\n      </ion-row>      \n\n      <report-errors padding #errors col-12 [hidden]="view==\'!result\' && report.result"></report-errors>\n\n      <report-result col-12 [parent]="this" *ngIf="view==\'result\' && (!!form && !form.invalid)"></report-result>\n\n      </ion-col>\n\n\n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n  <edit-picture *ngIf="view==\'edit_picture\'"  [report]="report"  [picture]="editing_picture" ></edit-picture>\n\n\n\n</ion-content>\n\n\n\n<report-footer [parent]="this"></report-footer>'/*ion-inline-end:"D:\Sofware Factory\tbi\src\pages\reports\isurface\report-isurface.component.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__services_report_service__["a" /* ReportService */],
...
var ReportInsulatedPipePage = /** @class */ (function (_super) {
    ...
    ReportInsulatedPipePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-report-pipe',template:/*ion-inline-start:"D:\Sofware Factory\tbi\src\pages\reports\ipipe\report-ipipe.component.html"*/'<report-header [parent]="this"></report-header>\n\n\n\n<ion-content #content>\n\n\n\n  <ion-grid [hidden]="view==\'edit_picture\'" class="fixed-col">\n\n    <ion-row>\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n        <form novalidate #form="ngForm" [hidden]="segment!=\'input\'" (submit)="calculate()">\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Component/Location</ion-label>\n\n                <ion-input tabindex="1" (ionFocus)="on_focus($event)" name="location" required data-val-required="Please input Component/Location"\n\n                  [(ngModel)]="report.component.fields.location" type="text"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2></ion-col>\n\n          </ion-row> \n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Operational time (hours)</ion-label>\n\n                <ion-input tabindex="2" (ionFocus)="on_focus($event)" required data-val-required="Please input operational time" name="operational_time" [(ngModel)]="report.component.fields.operational_time"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #time (change)="report.component.fields.operational_time=time.value" [type]="\'time\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-7>\n\n              <ion-item>\n\n                <ion-label stacked>External diameter (mm)</ion-label>\n\n                  <ion-input #after_time tabindex="3" (ionFocus)="on_focus($event)" name="nominal_diameter" required data-val-required="Please input Nominal diameter" [(ngModel)]="report.component.fields.nominal_diameter"\n\n                  type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-3>\n\n              <ion-item>\n\n                <ion-label stacked>Length (m)</ion-label>\n\n                  <ion-input tabindex="4" (ionFocus)="on_focus($event)" name="number" required data-val-required="Please input length" [(ngModel)]="report.component.fields.length" type="number"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-1></ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item class="edit_surface_material" [class.editable]="edit_surface_material">\n\n                <ion-label stacked>Surface material [ε]</ion-label>\n\n                <ion-input tabindex="5" class="literal" (ionFocus)="on_focus($event);toggle_surface_material(true)" [value]="report.component.fields.surface_material_friendly" type="text"></ion-input>\n\n                <ion-input tabindex="6" (ionFocus)="on_focus($event)" class="numeric" (focusout)="toggle_surface_material(false)" (ionFocus)="on_focus($event)" name="surface_material" required data-val-required="Please input surface emissivity" [(ngModel)]="report.component.fields.surface_material" type="number" (change)="set_surface_material(report.component.fields.surface_material, $event)"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <more pull-left #material (change)="set_surface_material(material.value, $event)" [type]="\'materials\'" modal-button></more>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Medium temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input #after_material tabindex="7" (ionFocus)="on_focus($event)" name="medium_temp" \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Medium temperature" \n\n                  required data-val-required="Please input Medium temperature"  \n\n                  [(ngModel)]="report.component.fields.medium_temp"\n\n                  type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col col-10>\n\n              <ion-item>\n\n                <ion-label stacked>Surface temperature (<sup>º</sup>C)</ion-label>\n\n                  <ion-input tabindex="8" (ionFocus)="on_focus($event)" name="surface_temp" \n\n                  [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Surface temperature" \n\n                  required data-val-required="Please input Surface temperature"  \n\n                  [(ngModel)]="report.component.fields.surface_temp" type="tel"></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n\n            <ion-col col-2>\n\n              <!-- <medium-temp #medium (change)="report.component.fields.surface_temp=medium.value" modal-button pull-left></medium-temp> -->\n\n              <medium-temp #medium [report]="report" modal-button pull-left></medium-temp>\n\n            </ion-col>\n\n          </ion-row>\n\n          <ion-row>\n\n              <ion-col col-10>\n\n                <ion-item>\n\n                  <ion-label stacked>Ambient temperature (<sup>º</sup>C)</ion-label>\n\n                    <ion-input tabindex="9" (ionFocus)="on_focus($event)" (keyup.enter)="on_keypress($event)" name="ambient_temp" \n\n                    [pattern]="patterns.REQUIRED_NUMBER" data-val-pattern="Please input a valid Ambient temperature" \n\n                  required data-val-required="Please input Ambient temperature"  \n\n                    [(ngModel)]="report.component.fields.ambient_temp"\n\n                    type="tel"></ion-input>\n\n                </ion-item>\n\n              </ion-col>\n\n              <ion-col col-2></ion-col>\n\n            </ion-row>\n\n        </form>\n\n      </ion-col>\n\n\n\n      <ion-col col-12 col-lg-6 no-padding>\n\n        <ion-row>\n\n            <ion-col col-12 picture-slide  [report]="report" [editable]="editable"  (onStartEdit)="on_picture_start_edit($event)">\n\n        </ion-col>\n\n      </ion-row>      \n\n      <report-errors padding #errors col-12 [hidden]="view==\'!result\' && report.result"></report-errors>\n\n      <report-result col-12 [parent]="this" *ngIf="view==\'result\' && (!!form && !form.invalid)"></report-result>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n  <edit-picture *ngIf="view==\'edit_picture\'"  [report]="report"  [picture]="editing_picture" ></edit-picture>\n\n\n\n</ion-content>\n\n\n\n<report-footer [parent]="this"></report-footer>'/*ion-inline-end:"D:\Sofware Factory\tbi\src\pages\reports\ipipe\report-ipipe.component.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__services_report_service__["a" /* ReportService */],
...
var ReportDamagedPage = /** @class */ (function (_super) {
    ...
    ReportDamagedPage.prototype.set_damaged_cladding_other = function (input) {
        this.report.component.fields.damaged_cladding_other = input.value;
    };
    ReportDamagedPage.prototype.set_damaged_insulation_other = function (input) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_project__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_licences_service__ = __webpack_require__(101);
